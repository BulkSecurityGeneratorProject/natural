...
@Component({
    selector: 'jhi-category-kb',
    templateUrl: './category-kb.component.html'
})
export class CategoryKbComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.categoryService.query({
            ...
            (res: HttpResponse<CategoryKb[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: CategoryKb) {
        return item.id;
    }
