...
@Injectable()
export class SubCategoryKbPopupService {
            ...
            if (id) {
                this.subCategoryService.find(id)
                    .subscribe((subCategoryResponse: HttpResponse<SubCategoryKb>) => {
                        const subCategory: SubCategoryKb = subCategoryResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.subCategoryModalRef(component, new SubCategoryKb());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    subCategoryModalRef(component: Component, subCategory: SubCategoryKb): NgbModalRef {
